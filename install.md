# krakowiak-adaptive-pretraining guide installation
...
activate krakowiak_adaptive_pretraining
```
...
To move beyond notebook prototyping, all reusable code should go into the `krakowiak-adaptive-pretraining/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `krakowiak-adaptive-pretraining` folder and use the modules inside your notebooks :
...
```python
from krakowiak-adaptive-pretraining.utils.paths import data_dir
data_dir()
```
